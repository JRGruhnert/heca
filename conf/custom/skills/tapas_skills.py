...
class TapaLeafSet:
    ...
    open_drawer = TapasConfig(label="OpenDrawer", id=2)
    ...
    open_slide = TapasConfig(label="OpenSlide", id=6)
    ...
    pick_red_table = TapasConfig(label="GrabRedTable", id=10)
    ...
    pick_red_drawer = TapasConfig(label="GrabRedDrawer", id=12)
    ...
    pick_pink_table = TapasConfig(label="GrabPinkTable", id=14)
    ...
    pick_pink_drawer = TapasConfig(label="GrabPinkDrawer", id=16)
    ...
    pick_blue_table = TapasConfig(label="GrabBlueTable", id=18)
    pick_blue_drawer = TapasConfig(label="GrabBlueDrawer", id=19)
