from hoopgn.objects.properties.handlers.parameters.parameter import StateParameter
...
from hoopgn.objects.properties.handlers.parameters.scalar_parameter import (
    ScalarParameter,
