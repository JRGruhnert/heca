...
class Entity3DPlot(Plot):
    ...
    def set_entity(
        ...
        current: TDEntity,
        goal: TDEntity,
        different_on_start: bool,
        solved_in_the_end: bool,
    ):
    ...
    def show_edges(self, p1: EntityPoint, p2: EntityPoint, diff: bool, solved: bool):
    ...
    def create(
        ...
        object_handles = [
            Line2D(
                ...
                marker="o",
                color="w",
                markerfacecolor=self.get_entity_color(self.object_label),
